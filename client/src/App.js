       ...
       <div className="suggested_update">
        ...
        {localStorage.getItem('user') ? (
          ...
          <div className="upload_message" >
            ...
            <p><b>Welcome to eLitmus assesment!</b> To Create a new Advertisement, the user has to sign up for the apllication first using any mail ID (Works with an Invalid Mail ID too). For example : "xyz@gmail.com". User can Sign-In using the same credentials again and again. <br /><br />
              <b>For Creating a Advertisement</b> you need to sign-in first. Then click the "UPLOAD PHOTO" Button. Select a Photo from your device, add a suitable caption to the Advertisement, and then click "CREATE Advertisement" Button. Wait till the photo gets uploaded. And then BOOM!!! Your Advertisement has been created(Scroll a bit if you don't find your post at the top).
              <br /><br />
    ...
    <div className="App">
      ...
      <div className="app__header">
        {/* <img
          ...
          alt="instagram"
        /> */}
        <h1 className="app__headerImage">Advertisement</h1>
